...
source /home/hendrik/.local/bin/virtualenvwrapper.sh

# Save current dir every time I hit enter
export PROMPT_COMMAND="pwd > /tmp/whereami"

# Required so that DEL Key is working
tput smkx
...
# custom aliases
alias checkupdates='sudo apt update && sudo apt upgrade && /bin/bash /home/hendrik/.scripts/copyall.sh'
alias gno='xdg-open'
alias apktools='java -jar /opt/apkTool'
alias dex2jar='~/Documents/Repositories/dex2jar/dex-tools/build/distributions/dex-tools/dex-tools-2.1-SNAPSHOT/d2j-dex2jar.sh'
alias r='ranger'
